...
ZEND_BEGIN_ARG_INFO_EX(arginfo_stub_9__closure___construct, 0, 0, 1)
	ZEND_ARG_INFO(0, abc)
ZEND_END_ARG_INFO()
...
PHP_ME(stub_9__closure, __invoke, arginfo_stub_9__closure___invoke, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL)
	PHP_ME(stub_9__closure, __construct, arginfo_stub_9__closure___construct, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL|ZEND_ACC_CTOR)
	PHP_FE_END
};
